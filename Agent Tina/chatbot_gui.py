...
class ChatBotGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Agent Tina - Chatbot ")
        self.root.geometry("500x600")
        self.root.resizable(False, False)

        # Title
        self.title = tk.Label(root, text="Agent Tina", font=("Helvetica", 18, "bold"), bg="#4A90E2", fg="white", pady=10)
    ...
    def bot_intro(self):
        self.display_message("Agent Tina", "Hi there! I'm Agent Tina. Ask me anything, or type 'bye' to exit.")
    ...
    def send_message(self, event=None):
        ...
        if user_msg:
            ...
            self.display_message("Agent Tina", bot_response)
